...
3. type `cmake ..` into the console while in the build folder
4. type `make` into the console while in the build folder
5. type ./MainApp to run the CLI.
